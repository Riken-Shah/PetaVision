...
class MyDataset(Dataset):
    def __init__(self, csv_path, pallete_csv_path, num_primary_color, mode=None):
        ...
        if mode == 'test':
            ...
            self.palette_list = np.array(pd.read_csv(pallete_csv_path)).reshape(-1, num_primary_color*3)
